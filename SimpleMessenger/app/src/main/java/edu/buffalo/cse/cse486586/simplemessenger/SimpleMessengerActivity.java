...
public class SimpleMessengerActivity extends Activity {
        ...
        editText.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                     ...
                     * http://developer.android.com/reference/android/os/AsyncTask.html
                     */
                    Log.i(TAG,"onKey down sending- " + msg);
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
             ...
             */
                ...
                try {
                    while (true) {
                        ...
                        Log.i(TAG, "Received msg in doInBackground Server- " + dataReceived);
                        publishProgress(dataReceived);
                        messageReader.close();
                        socket.close();
                    }
                } catch (IOException e) {
                    Log.e(TAG, "Exception msg in Server- " + dataReceived);
                    e.printStackTrace();
        ...
        protected void onProgressUpdate(String...strings) {
            ...
            try {
                Log.i(TAG,"msg onProgressUpdate Server- " + strReceived);
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                bw.write(msgToSend);
                Log.i(TAG,"Sent msg doInBackground in Cliet- " + msgToSend);
                bw.flush();
                bw.close();
                socket.close();
